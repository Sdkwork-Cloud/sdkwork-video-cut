...
CREATE TABLE IF NOT EXISTS ops_database_contract (
    ...
    CONSTRAINT pk_ops_database_contract PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS ops_task (
    ...
    CONSTRAINT pk_ops_task PRIMARY KEY (id),
...
CREATE INDEX IF NOT EXISTS idx_ops_task_queue_claim
    ON ops_task (queue_status, run_after_at, lease_expires_at, priority DESC, created_at, id);
...
CREATE TABLE IF NOT EXISTS ops_stage_run (
    ...
    updated_at TIMESTAMPTZ NOT NULL,
    version BIGINT NOT NULL DEFAULT 1,
    CONSTRAINT pk_ops_stage_run PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS ops_task_event (
    ...
    updated_at TIMESTAMPTZ NOT NULL,
    version BIGINT NOT NULL DEFAULT 1,
    CONSTRAINT pk_ops_task_event PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS ops_worker_lease (
    ...
    updated_at TIMESTAMPTZ NOT NULL,
    version BIGINT NOT NULL DEFAULT 1,
    CONSTRAINT pk_ops_worker_lease PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS media_artifact (
    ...
    version BIGINT NOT NULL DEFAULT 1,
    deleted_at TIMESTAMPTZ,
    CONSTRAINT pk_media_artifact PRIMARY KEY (id),
...
INSERT INTO ops_database_contract (
    id,
    uuid,
    tenant_id,
    contract_version,
