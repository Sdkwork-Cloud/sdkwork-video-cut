# SDKWork Autocut Voice Translate Component Specs

This directory is the local standards index for `@sdkwork/autocut-voice-translate`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-voice-translate` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-voice-translate` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-voice-translate typecheck`
