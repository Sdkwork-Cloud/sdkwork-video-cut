# SDKWork Autocut Types Component Specs

This directory is the local standards index for `@sdkwork/autocut-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-types` |
| Type | `node-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-types` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-types typecheck`
