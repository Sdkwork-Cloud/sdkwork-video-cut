# SDKWork Autocut Assets Component Specs

This directory is the local standards index for `@sdkwork/autocut-assets`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-assets` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-assets` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-assets typecheck`
