# SDKWork Autocut Video Compress Component Specs

This directory is the local standards index for `@sdkwork/autocut-video-compress`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-video-compress` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-video-compress` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-video-compress typecheck`
