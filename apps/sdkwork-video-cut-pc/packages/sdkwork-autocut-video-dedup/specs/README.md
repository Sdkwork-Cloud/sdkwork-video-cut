# SDKWork Autocut Video Dedup Component Specs

This directory is the local standards index for `@sdkwork/autocut-video-dedup`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-video-dedup` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-video-dedup` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-video-dedup typecheck`
