# SDKWork Autocut Extractor Text Component Specs

This directory is the local standards index for `@sdkwork/autocut-extractor-text`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-extractor-text` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-extractor-text` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-extractor-text typecheck`
