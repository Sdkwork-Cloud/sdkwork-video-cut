...
fn main() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::autocut_fingerprint_video_file,
            commands::autocut_probe_video_file_identity,
            commands::autocut_select_local_media_file,
            commands::autocut_select_local_video_file,
            commands::autocut_select_local_directory,
            commands::autocut_allow_local_media_preview_directory,
            commands::autocut_open_artifact_in_folder,
            commands::autocut_select_speech_transcription_file,
            commands::autocut_download_speech_transcription_model,
            ...
            commands::autocut_extract_audio_fingerprint,
            commands::autocut_generate_gif,
            commands::autocut_slice_video,
            commands::autocut_analyze_video_slice_audio_activity,
            commands::autocut_transcribe_media,
            commands::autocut_extract_visual_evidence,
            commands::autocut_write_task_evidence_json,
