# SDKWork Autocut Messages Component Specs

This directory is the local standards index for `@sdkwork/autocut-messages`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-messages` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-messages` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-messages typecheck`
