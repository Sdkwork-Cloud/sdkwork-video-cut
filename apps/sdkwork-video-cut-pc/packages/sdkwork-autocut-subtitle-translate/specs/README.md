# SDKWork Autocut Subtitle Translate Component Specs

This directory is the local standards index for `@sdkwork/autocut-subtitle-translate`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-subtitle-translate` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-subtitle-translate` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-subtitle-translate typecheck`
