# SDKWork Autocut Slicer Component Specs

This directory is the local standards index for `@sdkwork/autocut-slicer`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-slicer` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-slicer` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-slicer typecheck`
