# SDKWork Autocut Tasks Component Specs

This directory is the local standards index for `@sdkwork/autocut-tasks`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-tasks` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-tasks` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-tasks typecheck`
