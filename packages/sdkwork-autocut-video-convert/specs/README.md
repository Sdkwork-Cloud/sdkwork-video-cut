# SDKWork Autocut Video Convert Component Specs

This directory is the local standards index for `@sdkwork/autocut-video-convert`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-video-convert` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-video-convert` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-video-convert typecheck`
