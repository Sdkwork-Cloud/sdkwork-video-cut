...
This README is the SDKWork module entrypoint for `@sdkwork/autocut-assets`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
