# SDKWork Autocut Desktop Component Specs

This directory is the local standards index for `@sdkwork/autocut-desktop`.
...
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-desktop` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-desktop typecheck`
