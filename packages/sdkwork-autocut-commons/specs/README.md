# SDKWork Autocut Commons Component Specs

This directory is the local standards index for `@sdkwork/autocut-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-commons` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-commons` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-commons typecheck`
