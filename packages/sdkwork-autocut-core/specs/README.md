# SDKWork Autocut Core Component Specs

This directory is the local standards index for `@sdkwork/autocut-core`.
...
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-core` |
| Domain | `content` |
| Capability | `video` |
