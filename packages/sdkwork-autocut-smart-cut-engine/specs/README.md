# SDKWork Autocut Smart Cut Engine Component Specs

This directory is the local standards index for `@sdkwork/autocut-smart-cut-engine`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-smart-cut-engine` |
| Type | `node-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-smart-cut-engine` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-smart-cut-engine typecheck`
