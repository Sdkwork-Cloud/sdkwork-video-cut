# SDKWork Autocut Extractor Audio Component Specs

This directory is the local standards index for `@sdkwork/autocut-extractor-audio`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-extractor-audio` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-extractor-audio` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-extractor-audio typecheck`
