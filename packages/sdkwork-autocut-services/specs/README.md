# SDKWork Autocut Services Component Specs

This directory is the local standards index for `@sdkwork/autocut-services`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-services` |
| Type | `node-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-services` |
| Domain | `content` |
| Capability | `video` |
