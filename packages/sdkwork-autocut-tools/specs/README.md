# SDKWork Autocut Tools Component Specs

This directory is the local standards index for `@sdkwork/autocut-tools`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-tools` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-tools` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-tools typecheck`
