# SDKWork Autocut Video Gif Component Specs

This directory is the local standards index for `@sdkwork/autocut-video-gif`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-video-gif` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-video-gif` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-video-gif typecheck`
