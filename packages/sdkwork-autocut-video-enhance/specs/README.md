# SDKWork Autocut Video Enhance Component Specs

This directory is the local standards index for `@sdkwork/autocut-video-enhance`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-video-enhance` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-video-enhance` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-video-enhance typecheck`
