# SDKWork Autocut Settings Component Specs

This directory is the local standards index for `@sdkwork/autocut-settings`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/autocut-settings` |
| Type | `react-package` |
| Root | `sdkwork-video-cut/packages/sdkwork-autocut-settings` |
| Domain | `content` |
| Capability | `video` |
...
- `pnpm --filter @sdkwork/autocut-settings typecheck`
